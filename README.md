Download git. While installing be sure to select options allowing for using "Git Bash" only. On the git project site, click new pull request button to get the project on your computer.
